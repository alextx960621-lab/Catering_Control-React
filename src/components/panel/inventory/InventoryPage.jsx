...
export default function InventoryPage({ user }) {
  ...
  const itemColumns = [
    ...
    { key: 'id', label: 'Acciones', render: (item) => canEdit ? (
      <><button className="icon-btn info" onClick={() => setEditingItem(item)}>Editar</button><button className="icon-btn delete" onClick={() => handleItemDelete(item)}>Quitar</button></>
    ) : '—' },
  ];
  ...
  const linkColumns = [
    ...
    { key: 'id', label: 'Acciones', render: (l) => canEdit ? (
      <><button className="icon-btn info" onClick={() => setEditingLink(l)}>Editar</button><button className="icon-btn delete" onClick={() => handleLinkDelete(l)}>Quitar</button></>
    ) : '—' },
  ];
  ...
  const movementColumns = [
    ...
    { key: 'id', label: 'Acciones', render: (m) => (canEdit && m.type !== 'delivery') ? (
      <><button className="icon-btn info" onClick={() => setEditingMovement(m)}>Editar</button><button className="icon-btn delete" onClick={() => handleMovementDelete(m)}>Quitar</button></>
    ) : '—' },
  ];
